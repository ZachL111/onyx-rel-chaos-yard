...
`onyx-rel-chaos-yard` is centered on reliability work in Solidity. The technical target is: Develop a Solidity command-oriented project for chaos scenarios with fixture event logs, golden state snapshots, and offline replay mode.
...
The score is deterministic. The current threshold is 161. Risk has a penalty of 6, latency has a penalty of 4, and weight contributes a bonus of 6.
